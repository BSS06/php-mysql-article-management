...
--
-- Gazdă: 127.0.0.1
-- Timp de generare: mart. 26, 2026 la 07:23 PM
...
(1, 'Introducere în MySQL Distribuit', 'introducere-mysql-distribuit', 'Bazele de date distribuite permit stocarea datelor pe mai multe noduri simultan...', 'Ghid complet despre arhitectura MySQL în sisteme distribuite.', NULL, '2026-03-19 15:30:34', '2026-03-24 12:57:19', 2, 1, 8, 'publicat'),
(2, 'Optimizarea Interogărilor SQL', 'optimizarea-interogarilor-sql', 'Performanța interogărilor SQL depinde de indecși, planuri de execuție și structura schemei...', 'Tehnici avansate pentru optimizarea query-urilor MySQL.', NULL, '2026-03-19 15:30:34', '2026-03-19 15:30:34', 2, 1, 0, 'publicat'),
...
(9, 'JSON in MySQL - Ghid Complet', 'json-mysql-ghid-complet', 'MySQL 5.7+ suporta tipul de date JSON nativ, permitand stocarea documentelor semistructurate in tabele relationale. Functiile JSON_OBJECT, JSON_ARRAYAGG si JSON_EXTRACT ofera flexibilitate fara a sacrifica consistenta datelor.', 'Utilizarea tipului JSON in MySQL: functii, indecsi si cazuri practice.', NULL, NULL, '2026-03-23 15:45:45', 4, 1, 0, 'draft'),
(10, 'Inteligenta Artificiala in Medicina', 'ai-medicina', 'Modelele de machine learning analizeaza imagini medicale cu precizie comparabila specialistilor umani. Diagnosticul precoce al cancerului, interpretarea RMN si predictia evolutiei bolilor cronice sunt aplicatii reale implementate deja.', 'Cum transforma AI diagnosticul medical si tratamentul personalizat.', NULL, NULL, '2026-03-23 15:45:45', 5, 2, 0, 'draft'),
...
(26, 'Literatura Sci-Fi: De la Asimov la Liu Cixin', 'literatura-scifi-asimov-liu-cixin', 'Asimov a definit robotica ficationala cu cele Trei Legi. Philip K. Dick a explorat identitatea si realitatea. Liu Cixin a adus perspectiva civilizatiei asiatice in SF cu trilogia Problema celor Trei Corpuri. Hard SF-ul actual integreaza astrofizica si informatica cuantice.', 'Evolutia literaturii SF de la clasici americani la autorii contemporani.', NULL, '2026-03-22 10:00:00', '2026-03-23 16:02:46', 5, 4, 7, 'publicat'),
(27, 'Yoga si Sanatatea Coloanei Vertebrale', 'yoga-sanatate-coloana', 'Munca la birou produce dezechilibre posturale care acumulate duc la hernii de disc si spondiloza. Yoga tinteste direct musculatura paravertebrala si flexibilitatea soldurilor. Asanele Cat-Cow, Child Pose si Downward Dog sunt elementare dar extrem de eficiente.', 'Rutina de yoga pentru programatori cu dureri de spate.', NULL, '2026-03-22 11:00:00', '2026-03-23 16:02:46', 3, 5, 18, 'publicat'),
(28, 'Somnul: Impact asupra Performantei Cognitive', 'somn-performanta-cognitiva', 'Privarea de somn reduce capacitatea de concentrare cu pana la 40% in 24 de ore. In faza REM creierul consolideaza memoria si elimina produsele reziduale metabolice. Programatorii care dorm sub 6 ore produc cu 50% mai multe bug-uri decat cei cu 8 ore de somn.', 'Stiinta somnului si impactul sau direct asupra calitatii codului.', NULL, '2026-03-22 12:00:00', '2026-03-23 16:02:46', 4, 5, 22, 'publicat'),
(29, 'Design Thinking in Dezvoltarea Produselor', 'design-thinking-produse', 'Design Thinking este o metodologie centrata pe utilizator: Empathize, Define, Ideate, Prototype, Test. Prototiparea rapida reduce costul esecului. Testele cu utilizatori reali in faza timpurie previn construirea de functionalitati pe care nimeni nu le foloseste.', 'Aplicarea Design Thinking in ciclul de dezvoltare software.', NULL, '2026-03-22 13:00:00', '2026-03-23 16:02:46', 5, 6, 6, 'publicat'),
...
(34, 'Schimbari Climatice: Date si Tendinte', 'schimbari-climatice-date', 'Concentratia de CO2 a depasit 420 ppm in 2023, cel mai ridicat nivel din ultimii 3 milioane de ani. Temperatura globala a crescut cu 1.1 grade fata de era preindustriala. Evenimentele meteorologice extreme s-au triplat ca frecventa in ultimii 50 de ani.', 'Analiza datelor climatice recente si proiectii pentru 2050.', NULL, NULL, '2026-03-23 16:02:46', 5, 2, 0, 'draft'),
...
(1, 'Tehnologie', 'Articole despre IT, software și inovație digitală!', NULL, 1, '2026-03-19 15:29:56'),
(2, 'Știință', 'Descoperiri și cercetări științifice recente', NULL, 1, '2026-03-19 15:29:56'),
(3, 'Cultură', 'Arte, literatură și evenimente culturale', NULL, 1, '2026-03-19 15:29:56'),
(4, 'Economie', 'Analize economice și financiare', NULL, 1, '2026-03-19 15:29:56'),
(5, 'Sănătate', 'Sfaturi medicale și stil de viață sănătos', NULL, 1, '2026-03-19 15:29:56'),
(6, 'Educatie', 'Metode pedagogice, e-learning si sisteme de invatamant.', NULL, 0, '2026-03-23 15:45:45');
...
--
ALTER TABLE `articole`
  MODIFY `id_articol` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
