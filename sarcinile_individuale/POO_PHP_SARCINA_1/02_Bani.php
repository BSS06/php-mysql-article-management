...
class Bani {
    ...
    private function laBani() {
        return $this->lei * 100 + $this->bani;
    }
    ...
    public function aduna(Bani $b) {
        return Bani::dinBani($this->laBani() + $b->laBani());
    }

    public function scade(Bani $b) {
        return Bani::dinBani($this->laBani() - $b->laBani());
    }
    ...
    public function inmultesteCu($factor) {
        return Bani::dinBani((int)round($this->laBani() * $factor));
    }
    ...
    public function afiseaza() {
        echo $this->lei . " lei si " . str_pad($this->bani, 2, "0", STR_PAD_LEFT) . " bani";
    }
}
...
$suma = $b1->aduna($b2);
echo "b1 + b2 = "; $suma->afiseaza(); echo "\n";

$dif = $b1->scade($b2);
echo "b1 - b2 = "; $dif->afiseaza(); echo "\n";

$jum = $b1->imparteLaNumar(2);
echo "b1 / 2 = "; $jum->afiseaza(); echo "\n";

$dbl = $b1->inmultesteCu(1.5);
echo "b1 * 1.5 = "; $dbl->afiseaza(); echo "\n";
