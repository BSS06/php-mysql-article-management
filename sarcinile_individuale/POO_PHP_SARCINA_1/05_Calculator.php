...
class Calculator {
    ...
    public function esteIntreg($val) {
        return is_numeric($val) && (int)$val == $val;
    }

    public function aduna() {
        if (!$this->esteIntreg($this->a) || !$this->esteIntreg($this->b)) {
            echo "Eroare: ambele numere trebuie sa fie intregi!\n";
            return null;
        }
