...
class Triunghi {
    ...
    public function getLaturaCA() {
        return $this->distanta($this->x3, $this->y3, $this->x1, $this->y1);
    }

    public function getPerimetru() {
        return $this->getLaturaAB() + $this->getLaturaBC() + $this->getLaturaCA();
    }
    ...
    public function esteIsoscel() {
        $ab = round($this->getLaturaAB(), 6);
        $bc = round($this->getLaturaBC(), 6);
        $ca = round($this->getLaturaCA(), 6);
